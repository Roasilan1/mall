<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>登录密码:</label>
        <input v-model="registerForm.password" type="text" placeholder="请输入你的登录密码">
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="content">
        <label>确认密码:</label>
        <input v-model="repwd" type="text" placeholder="请输入确认密码">
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="controls">
...
<script>
  export default {
    ...
    methods: {
      //获取验证码
      getCode(){
        this.$store.dispatch("getCode",this.registerForm.phone);
      },
      //发送注册请求
      async register(){
        try{
