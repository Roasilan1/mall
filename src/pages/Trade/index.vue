  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img style="width: 82px; height: 82px" :src="item.imgUrl" alt="" />
          </li>
          <li>
            <p>
              {{ item.skuName }}
    ...
    <div class="trade" v-if="selectedAddress">
      <div class="price">
...
export default {
  ...
  methods: {
    //改变地址选中状态
    selectAddress(item) {
      this.selectedAddress.isDefault = "0";
      item.isDefault = "1";
    },
    //提交订单
    submitOrder() {
      ...
      this.$api.submitOrder(tradeNo,params).then(resolve=>{
        if(resolve.code===200)
          this.$router.push("/pay?orderId="+resolve.data);
        else
